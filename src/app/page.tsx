      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Your complete Point-of-Sale solution with integrated inventory management, 
            sales analytics, and subscription billing powered by Razorpay.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 h-full">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Efficiently manage your product catalog with barcode support, 
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 h-full">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Process transactions seamlessly with integrated POS, generate GST invoices, 
                and access comprehensive sales analytics and reports.
              </p>
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 h-full">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                ...
                automated reordering, and detailed inventory analytics.
              </p>
